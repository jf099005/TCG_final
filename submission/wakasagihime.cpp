...
int main()
{
    ...
    algorithm_name += "_limit_depth_" + std::to_string(acdc.lim_extend_depth) + "_";
    
    #ifndef ORDERING
    algorithm_name += "_no_ordering_";
    #endif

    #ifdef RANDOM_ORDERING
    algorithm_name += "_random_ordering_";
    #endif

    #ifdef RECORD_GAMES
    std::string basic_record_path = "/mnt/20F408ADF408876E/TCG/TCG_final/submission/record/" + algorithm_name + ".txt";
